...
tf.app.flags.DEFINE_string('image_folder', 
                           #'/home/ysm/fck/AttnGAN-manifold_big/output/birds_shallow_D_G_256_256_2021_03_31_19_14_28/Model/netG_epoch_1600/valid/single',
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session(config=config) as sess:
            with tf.device("/gpu:%d" % FLAGS.gpu):
                ...
                if not os.path.isfile('/home/yesenmao/disk/dataset/birds/IS.pkl'):
                
                    with open('/home/yesenmao/disk/dataset/birds/IS.pkl', 'wb') as f:
                        m2,s2 = get_inception_score(sess, images2, pred_op)
                        
                        pickle.dump([m2,s2], f, protocol=2)
                        print('Save to: ')
                else: 
                    with open('/home/yesenmao/disk/dataset/birds/IS.pkl', 'rb') as f:
                        x = pickle.load(f)
                        m2, s2 = x[0], x[1]                        
